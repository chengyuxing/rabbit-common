 ...
 * @see Comparators
 */
public class RabbitScriptInterpreter {
     ...
     */
    public RabbitScriptInterpreter(String input) {
        RabbitScriptLexer lexer = new RabbitScriptLexer(input) {
            @Override
            protected String normalizeDirectiveLine(String line) {
                return RabbitScriptInterpreter.this.normalizeDirectiveLine(line);
            }
        };
